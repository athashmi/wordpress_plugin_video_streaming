...
/*function live_channel_register() {
 
	$labels = array(
		'name' => _x('Live Channels', 'post type general name'),
		'singular_name' => _x('Live Channel', 'post type singular name'),
		'add_new' => _x('Add New', 'Live Channel'),
		'add_new_item' => __('Add New Live Channel'),
		'edit_item' => __('Edit Live Channel'),
		'new_item' => __('New Live Channel'),
		'view_item' => __('View Live Channel'),
		'search_items' => __('Search Live Channel'),
...
add_action('init', 'live_channel_register');
...
//add_action('init', 'portfolio_register');
add_action('init', 'recorded_channel_register');*/